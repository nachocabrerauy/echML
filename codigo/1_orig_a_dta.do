...
cd "$ruta\datos_originales"

import spss using "HyP_2018_Terceros.sav", clear
save "ech18.dta", replace

import spss using "HyP_2019_Terceros.sav", clear
save "ech19.dta", replace

import spss using "HyP_2020_Terceros.sav", clear
save "ech20.dta", replace


*-------------------------------------------------------------------------------
* Base segundo semestre 2021
import delimited "ECH_implantacion_sem2_2021.csv", clear
*-------------------------------------------------------------------------------
...
save "semestre2.dta", replace
*-------------------------------------------------------------------------------
* Base primer semestre 2021
import delimited "ECH_2021_sem1_terceros.csv", clear
*-------------------------------------------------------------------------------
...
save "semestre1.dta", replace

u "semestre1.dta", clear
append using "semestre2.dta", force
...
save "ech21.dta", replace
*-------------------------------------------------------------------------------

import delimited "ECH_2022.csv", clear
save "ech22.dta", replace

import delimited "ECH_implantacion_2023.csv", clear
save "ech23.dta", replace
...
import delimited "ECH_`x'_22.csv", clear
save "ECH_`x'_22.dta", replace
}

clear all
foreach x in "01" "02" "03" "04" "05" "06" "07" "08" "09" "10" "11" "12" {
append using "ECH_`x'_22.dta", force
}
save "ech_mens_22.dta", replace


foreach x in "01" "02" "03" "04" "05" "06" {
import delimited "ECH_`x'_23.csv", clear
save "ECH_`x'_23.dta", replace
}

foreach x in "07" "08" "09" "10" "11" "12" {
import delimited "ECH_`x'_2023.csv", clear
save "ECH_`x'_23.dta", replace
}
...
foreach x in "01" "02" "03" "04" "05" "06" "07" "08" "09" "10" "11" "12" {
append using "ECH_`x'_23.dta", force
}
save "ech_mens_23.dta", replace
