...
replace	bc_ipc=	0.286928386	if	bc_mes==	1	&	bc_anio==	2023
replace	bc_ipc=	0.282862714	if	bc_mes==	2	&	bc_anio==	2023
replace	bc_ipc=	0.279922584	if	bc_mes==	3	&	bc_anio==	2023
replace	bc_ipc=	0.277177445	if	bc_mes==	4	&	bc_anio==	2023
replace	bc_ipc=	0.27517356	if	bc_mes==	5	&	bc_anio==	2023
replace	bc_ipc=	0.275332804	if	bc_mes==	6	&	bc_anio==	2023
replace	bc_ipc=	0.276238679	if	bc_mes==	7	&	bc_anio==	2023
replace	bc_ipc=	0.276747504	if	bc_mes==	8	&	bc_anio==	2023
replace	bc_ipc=	0.275918278	if	bc_mes==	9	&	bc_anio==	2023
replace	bc_ipc=	0.274353725	if	bc_mes==	10	&	bc_anio==	2023
replace	bc_ipc=	0.272858967	if	bc_mes==	11	&	bc_anio==	2023
replace	bc_ipc=	0.271406209	if	bc_mes==	12	&	bc_anio==	2023
...
save "$rutacom/servdom23.dta", replace
restore
drop if e30==14
