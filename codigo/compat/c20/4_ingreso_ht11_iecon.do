...
cap drop ytdop_3 
gen ytdop_3 = 0
replace ytdop_3 = mto_cuot if (((e27>= 14) & (f73 <= 3 | f73==8 | f73 == 7) & f82==1) & (e45_1_1_cv == 1| e45_2_1_cv== 1 | e45_3_1_cv== 1)) 
...
gen YTINDE_2 = 0
replace YTINDE_2=mto_cuot if ((e27>= 14 & (f73>2 & f73<7 & f82==1) | e27>= 14 & (f92>2 & f92<7 & f96==1)) & (e45_1_1_cv == 1| e45_2_1_cv== 1 | e45_3_1_cv== 1) & ytdop_3==0 & ytdos_3==0 & ytdop_2==0 & ytdos_2==0)
...
replace CUOT_EMP_IAMC1=1 if (e45_2_1_cv==5) & ((e45_cv!=1 | e45_1_1_cv==2 | e45_1_1_cv==3) & (e45_cv!=3 | e45_3_1_cv==2)) // en sintaxis ine hicieron solo if e45_2_1_cv==5
	
egen CUOT_EMP_IAMC = sum(CUOT_EMP_IAMC1) if e45_2_1_1_cv>0, by (bc_correlat e45_2_1_1_cv) // en sintaxis ine no se hace ese if
...
replace CUOT_EMP_PRIV1=1 if (e45_3_1_cv==5) & ((e45_cv!=1 | e45_1_1_cv==2 | e45_1_1_cv==3) & (e45_cv!=2 | e45_2_1_cv==2)) // no en sintaxis ine

destring e45_3_1_1_cv, replace force
egen CUOT_EMP_PRIV = sum(CUOT_EMP_PRIV1) if e45_3_1_1_cv>0, by (bc_correlat e45_3_1_1_cv) // no en sintaxis ine
foreach i of num 1/14 {
	generate aux`i'=0
...
replace CUOT_EMP_ASSE1=1 if ((e45_1_1_cv==5) & (e45_cv!=2 | e45_2_1_cv==2) & (e45_cv!=3 | e45_3_1_cv==2)) // no en sintaxis ine
...
local yhog_var  "h160_1 h160_2 h163_1 h163_2 h164 h165 h166 h269_1 h167_1_1 h167_1_2 h167_2_1 h167_2_2 h167_3_1 h167_3_2 h167_4_1 h167_4_2 h170_1 h170_2 h271_1 h171_1 h172_1 h155_1 h156_1 h252_1"
recode `yhog_var' (999999 = 0)
...
*esto no está en la sintaxis del ine
bysort bc_correlat : egen ht11_iecon2 = max(ht11_iecon)	// agrego por hogar para que le asigne el ingreso a todos los integrantes del hogar
drop ht11_iecon 
rename ht11_iecon2 ht11_iecon

bysort bc_correlat : egen ht11_ine2 = max(ht11)	// agrego por hogar para que le asigne el ingreso a todos los integrantes del hogar
...
g afam_cont_pub=0
	replace afam_cont_pub=1 if afam_cont==1 & (f73==2 | f92==2 | f73==8 | f92==8)
g afam_cont_priv=0
