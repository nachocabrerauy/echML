...
*- Valor locativo
* en 2020 no tenemos información sobre relación tenencia de la vivienda (ni d8_1 ni h5_cv) por lo que no se puede hacer la corrección del salario en especie
...
gen sal_esp_net=0
	replace sal_esp_net=g129_2-bc_pg14 if h5_cv==6 & g129_2!=0 // Salario en especie neto de valor locativo para ocupantes en rel. de dependencia
gen corr_sal_esp=0
