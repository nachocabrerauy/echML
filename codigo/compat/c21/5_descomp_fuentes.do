...
egen YALIMENT_MEN = sum(YALIMENT_MEN1), by(bc_correlat)
	replace YALIMENT_MEN=0 if bc_nper>1  // En 2021, se lo asigno al primer miembro del hogar en la base
*replace YALIMENT_MEN=0 if n_miembro>1 
*Tansferencias jubilaciones y pensiones.

g YTRANSF_1 = 0
	replace YTRANSF_1 = g148_1_1 + g148_1_2 + g148_1_3 + g148_1_4 + g148_1_5 + g148_1_6 + g148_1_7 + g148_1_8 + g148_1_9 + g148_1_12 + g148_1_10 + g148_1_11 + g148_2_1+ g148_2_2 + g148_2_3 + g148_2_4+ g148_2_5+ g148_2_6+ g148_2_7+ g148_2_8+ g148_2_9 + g148_2_12 + g148_2_10+ g148_2_11+ g148_3 + g148_4 + g148_5_1 + g148_5_2+ g153_1+ g153_2
...
cap drop bc_pg14
gen bc_pg14=0
	replace bc_pg14= ine_ht13 /*d8_3 if (d8_1!=6 & (d8_1!=5 & loc!=900))	// Código compatible
...
*/ //en 2021 no tenemos d8_1 y d8_3 para el primer semestre, y solo tenemos d8_3 en el segundo semestre para propietarios

gen sal_esp_net=0
	replace sal_esp_net=g129_2-bc_pg14 if d8_1_aux==6 /*en 2021 no tenemos d8_1 para PS, usamos h5_cv)*/ & g129_2!=0 // Salario en especie neto de valor locativo para ocupantes en rel. de dependencia
...
cap drop bc_pg17p
gen bc_pg17p=0
replace bc_pg17p= g126_8+g127_3+g128_1+g129_2+g130_1+(g127_1*mto_desa)+(g127_2*mto_alm)+g131_1+(g132_1*mto_vac)+(g132_2*mto_ovej)+(g132_3*mto_cab)+g133_1+(g133_2/12)+EMER_EMP_TOT +CUOT_EMP_PRIV_TOT + CUOT_EMP_IAMC_TOT+CUOT_EMP_ASSE_TOT +corr_sal_esp if bc_cat2==1

cap drop bc_pg27p
gen bc_pg27p=0
replace bc_pg27p = g126_8+g127_3+g128_1+g129_2+g130_1+(g127_1*mto_desa)+(g127_2*mto_alm)+g131_1+(g132_1*mto_vac)+(g132_2*mto_ovej)+(g132_3*mto_cab)+g133_1+(g133_2/12)+EMER_EMP_TOT+CUOT_EMP_PRIV_TOT+CUOT_EMP_IAMC_TOT+CUOT_EMP_ASSE_TOT +corr_sal_esp if bc_cat2==2
sum bc_pg27p
...
gen bc_pg42o=-13
gen bc_pg92o=0
replace bc_pg92o=g148_4+mto_hogc if (inrange(bc_mes,1,6) & (f73==6 | f73==5)) | (inrange(bc_mes,7,12) & f73==9) & (bc_pf41!=5 & bc_pf41!=6 & bc_pf41!=3 & bc_pf41!=2 & bc_pf41!=1)
...
gen bc_pg41o=-13
gen bc_pg43o=-13
gen bc_pg91o=g142 + ((g145+g146+g147)/12) if ((bc_pg31p==0|bc_pg31p==.) | (bc_pg41p==0|bc_pg41p==.)) & f92==9 & (bc_pf41!=3 & bc_pf41!=4 & bc_pf41!=5 & bc_pf41!=6) 
gen bc_pg93o=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5 if f92==9 & (bc_pf41!=3 & bc_pf41!=4 & bc_pf41!=5 & bc_pf41!=6)
gen bc_pg51o=g142 + ((g145+g146+g147)/12) if (bc_pg51p==0|bc_pg51p==.) & f92==4 & (f73!=3 & bc_cat2!=3 & bc_cat2!=4)
gen bc_pg52o=g144_1+g144_2_1+g144_2_2+g144_2_3+g144_2_4+g144_2_5 if f92==4 & (f73!=3 & bc_cat2!=3 & bc_cat2!=4)
gen bc_pg71o=g142 + ((g145+g146+g147)/12) if (bc_pg71p==0|bc_pg71p==.) & f92==3 & (f73!=3 & bc_cat2!=3 & bc_cat2!=4)
...
replace bc_otros_benef=g148_4+mto_hogc+YTRANSF_4+YALIMENT_MEN1 if bc_cat2!=1 & bc_cat2!=2 & f73!=3 & bc_cat2!=4 & f92!=1 & f92!=2 & f92!=3 & f92!=9 & /*bc_pe4==1*/ n_miembro==1 // en 2021 hay problemas con la relación de parentesco y algunos hogares no tienen jefe
replace bc_otros_benef=YTRANSF_2+g148_4+mto_hogc+YTRANSF_4+YALIMENT_MEN1 if bc_cat2!=1 & bc_cat2!=2 & f73!=3 & bc_cat2!=4 & f92!=1 & f92!=2 & f92!=3 & f92!=9 & /*bc_pe4==1*/ n_miembro==1 // en 2021 hay problemas con la relación de parentesco y algunos hogares no tienen jefe
...
replace bc_pg111= bc_pg111+emerg_otrohog_h+h155_1+h156_1 if /*bc_pe4==1*/ n_miembro==1 // en 2021 hay problemas con la relación de parentesco y algunos hogares no tienen jefe
gen bc_pg112=0
replace bc_pg112=g153_2
replace bc_pg112 = bc_pg112+h172_1/12 if /*bc_pe4==1*/ n_miembro==1 // en 2021 hay problemas con la relación de parentesco y algunos hogares no tienen jefe
...
replace bc_otras_utilidades=h170_1/12+h170_2/12+g143/12+h271_1/12 if ((f73!=3&bc_cat2!=3&bc_cat2!=4&f92!=3&f92!=4&f92!=9)|(bc_cat2==-9 & f92==0)) & /*bc_pe4==1*/ n_miembro==1 // en 2021 hay problemas con la relación de parentesco y algunos hogares no tienen jefe
...
replace bc_ot_utilidades=h170_1/12+h170_2/12+h271_1/12 if (f73==3|bc_cat2==3|bc_cat2==4|f92==3|f92==4|f92==9) & /*bc_pe4==1*/ n_miembro==1 // en 2021 hay problemas con la relación de parentesco y algunos hogares no tienen jefe


gen bc_otras_capital=0 // Medianería, pastoreo y ganado a capitalizar a nivel de hogar
replace bc_otras_capital=(h164+h165+h166)/12 if /*bc_pe4==1*/ n_miembro==1 // en 2021 hay problemas con la relación de parentesco y algunos hogares no tienen jefe

gen otros=0
replace otros=bc_pag_at+g154_1+g258_1/12 
replace otros=(h171_1)/12+bc_pag_at+g154_1+g258_1/12  if /*bc_pe4==1*/ n_miembro==1 // en 2021 hay problemas con la relación de parentesco y algunos hogares no tienen jefe
